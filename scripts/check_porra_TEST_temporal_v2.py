...
TARGET_WEEKDAY_MADRID = 2   # TEMPORAL PRUEBA: miércoles (revertir a 0 = lunes después de probar)
TARGET_HOUR_MADRID = 17     # TEMPORAL PRUEBA: hora actual (revertir a 21 después de probar)
